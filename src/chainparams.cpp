...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Aias: 1 day
        nTargetSpacing = 3 * 60;  // Aias: 1 minute
        nMaturity = 10;
        ...
        nZerocoinStartTime = 1629655628; // Disabled
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0448a27a7a84fb0fc0e2cf37d3f1edbde8a39003540dc29e5fde5b68773caac5d2884e98926ffc901e79644554b035da7feb3c82f375578973a745124b568e15b1") << OP_CHECKSIG;
        ...
        vSeeds.push_back(CDNSSeedData("149.28.164.181","149.28.164.181"));
        vSeeds.push_back(CDNSSeedData("45.32.48.155","45.32.48.155"));
        vSeeds.push_back(CDNSSeedData("45.76.139.155","45.76.139.155"));
        vSeeds.push_back(CDNSSeedData("45.63.59.44","45.63.59.44"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Aias: 1 day
        nTargetSpacing = 1 * 60;  // Aias: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seeds-testnet.aias.org", "seeds-testnet.aias.org"));           // DNS seeds
        vSeeds.push_back(CDNSSeedData("aias-testnet.mnseeds.com", "aias-testnet.mnseeds.com"));       // DNS seeds by mn.zone

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet aias addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet aias script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet aias BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet aias BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet aias BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Aias: 1 day
        nTargetSpacing = 1 * 60;        // Aias: 1 minutes
